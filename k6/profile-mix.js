...
export const options = {
  ...
  scenarios: {
    ticker: {
      ...
      preAllocatedVUs: Number(__ENV.TICKER_PRE_VUS || 30),
      maxVUs: Number(__ENV.TICKER_MAX_VUS || 300),
      gracefulStop: '0s',
    ...
    listMain: {
      ...
      timeUnit: '1s',
      duration: __ENV.DURATION || '6m',
      preAllocatedVUs: Number(__ENV.LIST_MAIN_PRE_VUS || 100),
      maxVUs: Number(__ENV.LIST_MAIN_MAX_VUS || 1000),
      gracefulStop: '0s',
    ...
    listCategory: {
      ...
      timeUnit: '1s',
      duration: __ENV.DURATION || '6m',
      preAllocatedVUs: Number(__ENV.LIST_CATEGORY_PRE_VUS || 40),
      maxVUs: Number(__ENV.LIST_CATEGORY_MAX_VUS || 400),
      gracefulStop: '0s',
    ...
    search: {
      ...
      timeUnit: '1s',
      duration: __ENV.DURATION || '6m',
      preAllocatedVUs: Number(__ENV.SEARCH_PRE_VUS || 40),
      maxVUs: Number(__ENV.SEARCH_MAX_VUS || 400),
      gracefulStop: '0s',
